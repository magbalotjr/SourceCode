...
public class Resume1 {
	public static void main (String [] args) {
		...
		frame.setLayout(null);
			...
			name = new JLabel("Romelitober Miguel G. Lacanaria");
			frame.add(name);
	...
	des.setBounds(10,30,900,55);
			...
			addr1 = new JLabel("Cafe, Concepcion, Tarlac");
			frame.add(addr);
			frame.add(addr1);
	...
	des1.setBounds(10,15,900,345);	
			...
			elem1 = new JLabel("Cafe Elementary School");
			yr1 = new JLabel("| S.Y. 2013-2014");
			frame.add(elem);
			frame.add(elem1);
			frame.add(yr1);
			...
			high1 = new JLabel("Benigno S. Aquino National High School");
			yr2 = new JLabel("| S.Y. 2019-2020");
			frame.add(high);
			frame.add(high1);
			frame.add(yr2);
	...
	des3.setBounds(10,15,900,805);	
			...
			bm1 = new JLabel("* Wonder");
			bm2 = new JLabel("* Lord of the Rings");
			bm3 = new JLabel("* Spirited Away");
			frame.add(bm1);
			frame.add(bm2);
			frame.add(bm3);
